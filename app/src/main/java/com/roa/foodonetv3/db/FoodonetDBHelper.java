...
public class FoodonetDBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        /** create the tables */
        String sql = String.format("CREATE TABLE %1$s(%2$s INTEGER PRIMARY KEY,%3$s TEXT,%4$s TEXT,%5$s TEXT,%6$s INTEGER,%7$s REAL,%8$s REAL,%9$s REAL,%10$s,%11$s TEXT,%12$s TEXT," +
                "%13$s INTEGER,%14$s INTEGER,%15$s REAL,%16$s INTEGER,%17$s TEXT,%18$s INTEGER,%19$s TEXT)",
        ...
        sqLiteDatabase.execSQL(sql);
        sql = String.format("CREATE TABLE %1$s(%2$s INTEGER PRIMARY KEY AUTO INCREMENT,%3$s INTEGER,%4$s INTEGER,%5$s TEXT,%6$s TEXT,%7$s INTEGER)",
        ...
        sqLiteDatabase.execSQL(sql);
        sql = String.format("CREATE TABLE %1$s(%2$s INTEGER PRIMARY KEY AUTO INCREMENT,%3$s INTEGER,%4$s TEXT,%5$s REAL,%6$s REAL)",
